...
**Thanks for helping grow this collection of offline LLM images!**

</div>

There are two common contributions: **adding a new model** and **improving an
existing one**. Both are quick — every model follows the same convention.
